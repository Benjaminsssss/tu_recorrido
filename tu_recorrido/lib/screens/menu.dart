  ...
  void _filterPlacesByDistance() {
    ...
    nearbyPlaces.sort((a, b) {
      double distA = Geolocator.distanceBetween(
        _currentPosition!.latitude, _currentPosition!.longitude, a.ubicacion.latitude, a.ubicacion.longitude);
      double distB = Geolocator.distanceBetween(
        _currentPosition!.latitude, _currentPosition!.longitude, b.ubicacion.latitude, b.ubicacion.longitude);
    ...
    _showSnackBar('Lugares cercanos actualizados: ${_lugares.length} encontrados en 5 km.');
  }
  ...
  Future<void> _determinePositionAndStartListening() async {
    ...
    try {
      Position initialPosition = await Geolocator.getCurrentPosition(
          ...
          onTimeout: () => throw TimeoutException('No se pudo obtener la ubicación a tiempo.')
      );
