...
class Coloressito {
  ...
  static const Color adventureGreen = Color(
    0xFF1DB954,
  ); // Verde aventura (botón principal)
  static const Color brightGreen = Color(
    0xFF1ed760,
  ); // Verde brillante (gradiente)

  // Colores de insignias/elementos flotantes
  static const Color badgeRed = Color(0xFFe57373); // Rojo insignia (ubicación)
  static const Color badgeYellow = Color(
    0xFFffb74d,
  ); // Amarillo insignia (estrella)
  ...
  static const Color surfaceLight = Color(
    0x33FFFFFF,
  ); // Blanco transparente para cards
