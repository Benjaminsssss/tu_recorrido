              ...
              child: GestureDetector(
                onPanUpdate: (details) {
                  setState(() {
                    ...
                    _rotationY += details.delta.dx * 0.01; // Sensibilidad horizontal
                    _rotationX -= details.delta.dy * 0.01; // Sensibilidad vertical (invertida)
                          ...
                          child: Container(
                            ...
                            child: ClipOval(
                              child: widget.estacion.badgeImage != null
                                  ? Image(
                                      image: widget.estacion.badgeImage!.imageProvider(),
                                      fit: BoxFit.cover,
                                      width: 250,
                                      height: 250,
                                    )
