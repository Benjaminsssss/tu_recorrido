...
class _PlaceSearchBarState extends State<PlaceSearchBar> {
  ...
  void _selectPlace(Place place) {
    ...
    _recentPlaces.removeWhere((p) =>
        '${p.nombre.toLowerCase()}|${p.comuna.toLowerCase()}' == key);
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _isFocused ? const Color(0xFFC88400) : const Color(0xFFE8EAE4), // mostaza al focus, neutro normal
              width: 1,
            ),
            boxShadow: const [
              BoxShadow(
